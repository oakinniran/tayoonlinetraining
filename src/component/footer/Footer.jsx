      ...
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          <div className="mt-6 lg:max-w-sm">
            ...
            24/7
Hremsoft Customer Support is available free of charge. You only incur charges on your call. Kindly use email.
            </p>
          </div>
        </div>
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            ...
            <a
              href="tel:+234 803 3905 561"
              aria-label="Our phone"
              title="Our phone"
              className="transition-colors duration-300 text-gray-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
            >
              +234 803 3905 561
            </a>
          </div>
          ...
          <div className="flex">
            ...
            <a
              ...
              title="Our address"
              className="transition-colors text-gray-300 duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
            >
              no 6 ogunyemi street chaliboy gbagada oshodi Lagos State
            </a>
          </div>
        </div>
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            <a
              href="https://twitter.com/i/flow/login?redirect_after_login=%2Fhremsoft%2F"
            ...
            <a
              href="https://www.instagram.com/hremsoft/"
              className="text-gray-300 transition-colors duration-300 hover:text-deep-purple-accent-400"
            >
