  ...
  return (
    <div className='bg-slate-300'>
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            ...
            <div class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none py-16 tracking-tight text-gray-900 sm:text-4xl md:mx-auto bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
        ...
        <form action="#" autoComplete="off">
            ...
            <div class="flex items-center justify-center mt-6">
                ...
                <span target="_blank" class="inline-flex items-center text-sm font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white">
                        You don&#x27;t have an account? <a href='http://localhost:3000/signup'> Sign Up here</a>
                    </span>
            </div>
        </div>
            </div>
